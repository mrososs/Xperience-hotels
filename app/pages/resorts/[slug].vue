    ...
    ? [
        {
          ...
          innerHTML: JSON.stringify({
            ...
            geo: {
              '@type': 'GeoCoordinates',
              latitude: resort.value.coords.lat,
              longitude: resort.value.coords.lng,
            },
            hasMap: `https://www.google.com/maps/search/?api=1&query=${resort.value.coords.lat},${resort.value.coords.lng}`,
            priceRange: `$${resort.value.priceFrom}+`,
            starRating: { '@type': 'Rating', ratingValue: '5' },
            amenityFeature: [
              { '@type': 'LocationFeatureSpecification', name: 'Spa', value: true },
              { '@type': 'LocationFeatureSpecification', name: 'Conference / event facilities', value: true },
              { '@type': 'LocationFeatureSpecification', name: 'Wedding & events service', value: true },
            ],
            makesOffer: {
              '@type': 'Offer',
              name: 'Book Direct — VIP perks & package savings',
              category: 'Direct booking',
              url: `https://xperience-hotels.com/offers`,
            },
            aggregateRating: {
              '@type': 'AggregateRating',
              ratingValue: resort.value.ratingScore,
              bestRating: '10',
              reviewCount: resort.value.reviewCount,
            },
          }),
        },
      ]
